...
export default class WhatsappController {
    ...
    initEvents() {
        ...
        this.el.formPanelAddContact.on('submit', e => {
            ...
            contact.on('datachange', data => {
                if(data.name) {
                    ...
                    console.info('contato não encontrado')
                }
            })
        })
        ...
        this.el.btnTakePicture.on('click', () => {
            let pictureBase64 = this._camera.takePicture()

            this.el.pictureCamera.src = pictureBase64
        ...
        this.el.btnSendMicrophone.on('click', () => {
            ...
            this._microphoneController.on('recordingTimer', timer => {
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            emoji.on('click', () => {
                ...
                let cursor = window.getSelection() // pega o texto selecionado 
                ...
                range = cursor.getRangeAt(0) // pega esse mesmo texto selecionado do curso a partir da posição 0

                range.deleteContents() // deleta eles

                let frag = document.createDocumentFragment()

                frag.appendChild(img)

                range.insertNode(frag) // insere o fragmento no lugar

                range.setStartAfter(img) // coloca a traço de escrita uma casa depois da img (frag)
