...
export default class ContactController extends ClassEvents{
    constructor(modal, user, contactAtive) {
        super()

        this._user = user
        this._modalEl = modal
        this._listEl = document.querySelector('#contact-list')
        this._contactAtive = contactAtive
    }
    ...
    open() {
        this._user.getContacts().then(contacts => {
            ...
            contacts.forEach(contact => {
                if(contact.email !== this._contactAtive.email) {
