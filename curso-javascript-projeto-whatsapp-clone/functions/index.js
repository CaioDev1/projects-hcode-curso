...
exports.saveLastMessage = functions.firestore.document('/chats/{chatId}/messages/{messageId}')
        ...
        return new Promise((resolve, reject) => {
            ...
            chatRef.onSnapshot(snapChat => {
                ...
                messageRef.onSnapshot(snapMessage => {
                    ...
                    let userTo = Object.keys(chatDoc).filter(key => {return (key !== encode64(userFrom))})[0]

                    db.collection('users').doc(decode64(userTo)).collection('contacs').doc(encode64(userFrom)).set({
...
// comando para o deploy da function no cloud do firebase pelo CLI
